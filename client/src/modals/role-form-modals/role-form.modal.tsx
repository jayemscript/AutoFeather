...
import useRoleFormModalLogic from "./role-form.logic";
...
const RoleFormModal: React.FC<FormModalProps> = ({
  open,
  close,
  mode = "add",
  onSuccess,
  ...
  const {
    ...
    setFormData,
    handleChange,
  } = useRoleFormModalLogic(open, close, mode, initialData, onSuccess);
